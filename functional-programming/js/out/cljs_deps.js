...
goog.addDependency("../codemirror.js", ['module$resources$public$js$libs$codemirror_5_5$lib$codemirror'], []);
goog.addDependency("../clojure.js", ['module$resources$public$js$libs$codemirror_5_5$mode$clojure$clojure'], ['module$resources$public$js$libs$codemirror_5_5$lib$codemirror']);
goog.addDependency("../cljs_present/code.js", ['cljs_present.code'], ['goog.dom', 'cljs.js', 'cljs.core', 'goog.object', 'goog.events.EventType', 'module$resources$public$js$libs$codemirror_5_5$lib$codemirror', 'module$resources$public$js$libs$codemirror_5_5$mode$clojure$clojure', 'goog.ui.Button', 'goog.events']);
goog.addDependency("../cljs_present/core.js", ['cljs_present.core'], ['goog.dom', 'markdown.core', 'goog.net.XhrIo', 'cljs.core', 'goog.events.KeyHandler', 'cljs_present.code', 'clojure.string', 'goog.events']);
