...
var G__6343 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch = G__6343;
continue;
}
break;
...
return cljs.tools.reader.read_tagged.call(null,(function (){var G__6345 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__6345,ch);
...
if(("\\" === ch__$1)){
var ch_6346__$2 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
if((ch_6346__$2 == null)){
cljs.tools.reader.reader_types.reader_error.call(null,rdr,"EOF while reading regex");
} else {
}

sb.append(ch_6346__$2);
} else {
}

var G__6347 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch__$1 = G__6347;
continue;
}
}
...
var args6348 = [];
var len__1277__auto___6351 = arguments.length;
var i__1278__auto___6352 = (0);
while(true){
if((i__1278__auto___6352 < len__1277__auto___6351)){
args6348.push((arguments[i__1278__auto___6352]));

var G__6353 = (i__1278__auto___6352 + (1));
i__1278__auto___6352 = G__6353;
continue;
} else {
}
break;
...
if(cljs.core.truth_((function (){var or__219__auto__ = cljs.tools.reader.impl.utils.whitespace_QMARK_.call(null,ch);
if(or__219__auto__){
return or__219__auto__;
} else {
var or__219__auto____$1 = cljs.tools.reader.macros.call(null,ch);
...
var vec__6360 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__6360,(0),null);
var start_column = cljs.core.nth.call(null,vec__6360,(1),null);
...
var G__6361 = cljs.core.conj_BANG_.call(null,a,form);
a = G__6361;
continue;
}
}
...
var _STAR_read_delim_STAR_6363 = cljs.tools.reader._STAR_read_delim_STAR_;
...
}finally {cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR_6363;
}});
/**
 * Read in a list, including its location if the reader is an indexing reader
 */
cljs.tools.reader.read_list = (function cljs$tools$reader$read_list(rdr,_,opts,pending_forms){
var vec__6366 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__6366,(0),null);
var start_column = cljs.core.nth.call(null,vec__6366,(1),null);
var the_list = cljs.tools.reader.read_delimited.call(null,")",rdr,opts,pending_forms);
var vec__6367 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__6367,(0),null);
var end_column = cljs.core.nth.call(null,vec__6367,(1),null);
...
var vec__6370 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__6370,(0),null);
var start_column = cljs.core.nth.call(null,vec__6370,(1),null);
var the_vector = cljs.tools.reader.read_delimited.call(null,"]",rdr,opts,pending_forms);
var vec__6371 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__6371,(0),null);
var end_column = cljs.core.nth.call(null,vec__6371,(1),null);
...
var vec__6374 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__6374,(0),null);
var start_column = cljs.core.nth.call(null,vec__6374,(1),null);
...
var vec__6375 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__6375,(0),null);
var end_column = cljs.core.nth.call(null,vec__6375,(1),null);
...
var sb = (function (){var G__6378 = (new goog.string.StringBuffer());
G__6378.append(initch);
...
var or__219__auto__ = cljs.tools.reader.impl.commons.match_number.call(null,s);
...
var G__6380 = (function (){var G__6379 = sb;
G__6379.append(ch);

return G__6379;
})();
var G__6381 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
sb = G__6380;
ch = G__6381;
continue;
}
...
switch (G__6388) {
case "\\":
var G__6392 = (function (){var G__6389 = sb;
G__6389.append(cljs.tools.reader.escape_char.call(null,sb,reader));

return G__6389;
})();
var G__6393 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__6392;
ch = G__6393;
continue;
...
break;
default:
var G__6394 = (function (){var G__6390 = sb;
G__6390.append(ch);

return G__6390;
})();
var G__6395 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__6394;
ch = G__6395;
continue;
...
var vec__6397 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__6397,(0),null);
var end_column = cljs.core.nth.call(null,vec__6397,(1),null);
...
var vec__6400 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__6400,(0),null);
var column = cljs.core.nth.call(null,vec__6400,(1),null);
...
var or__219__auto__ = cljs.core.get.call(null,cljs.tools.reader._STAR_alias_map_STAR_,sym);
if(cljs.core.truth_(or__219__auto__)){
return or__219__auto__;
} else {
...
var vec__6409 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__6409,(0),null);
var column = cljs.core.nth.call(null,vec__6409,(1),null);
...
var m__$1 = (cljs.core.truth_((function (){var and__207__auto__ = line;
...
var vec__6412 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__6412,(0),null);
var column = cljs.core.nth.call(null,vec__6412,(1),null);
var m = cljs.tools.reader.impl.utils.desugar_meta.call(null,cljs.tools.reader.read_STAR_.call(null,rdr,true,null,opts,pending_forms));
if(cljs.core.map_QMARK_.call(null,m)){
} else {
cljs.tools.reader.reader_types.reader_error.call(null,rdr,"Metadata must be Symbol, Keyword, String or Map");
...
var vec__6417 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__6417,(0),null);
var start_column = cljs.core.nth.call(null,vec__6417,(1),null);
var start_column__$1 = (cljs.core.truth_(start_column)?((start_column - (1)) | (0)):null);
var the_set = cljs.core.set.call(null,cljs.tools.reader.read_delimited.call(null,"}",rdr,opts,pending_forms));
var vec__6418 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__6418,(0),null);
var end_column = cljs.core.nth.call(null,vec__6418,(1),null);
...
var G__6420 = rdr;
cljs.tools.reader.read_STAR_.call(null,G__6420,true,null,opts,pending_forms);
...
var _STAR_suppress_read_STAR_6422 = cljs.tools.reader._STAR_suppress_read_STAR_;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR_6422;
}});
...
var G__6424 = cljs.tools.reader.read_STAR_.call(null,rdr,false,cljs.tools.reader.READ_EOF,")",opts,pending_forms);
cljs.tools.reader.check_eof_error.call(null,G__6424,rdr,first_line);

cljs.tools.reader.check_invalid_read_cond.call(null,G__6424,rdr,first_line);

return G__6424;
} else {
var or__219__auto__ = cljs.tools.reader.read_suppress.call(null,first_line,rdr,opts,pending_forms);
if(cljs.core.truth_(or__219__auto__)){
return or__219__auto__;
} else {
...
var G__6429 = matched;
var G__6430 = cljs.tools.reader.read_suppress.call(null,first_line,rdr,opts,pending_forms);
matched = G__6429;
finished = G__6430;
continue;
} else {
...
if(cljs.core.not.call(null,(function (){var and__207__auto__ = opts;
if(cljs.core.truth_(and__207__auto__)){
...
var _STAR_suppress_read_STAR_6432 = cljs.tools.reader._STAR_suppress_read_STAR_;
cljs.tools.reader._STAR_suppress_read_STAR_ = (function (){var or__219__auto__ = cljs.tools.reader._STAR_suppress_read_STAR_;
if(cljs.core.truth_(or__219__auto__)){
return or__219__auto__;
} else {
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR_6432;
}}
} else {
return cljs.tools.reader.reader_types.reader_error.call(null,rdr,"EOF while reading character");
}
...
var arg_env6435 = cljs.tools.reader.arg_env;
cljs.tools.reader.arg_env = cljs.core.sorted_map.call(null);

try{var form = cljs.tools.reader.read_STAR_.call(null,(function (){var G__6436 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__6436,"(");
...
var G__6437 = (i + (1));
var G__6438 = cljs.core.conj_BANG_.call(null,args,(function (){var or__219__auto__ = cljs.core.get.call(null,cljs.tools.reader.arg_env,i);
if(cljs.core.truth_(or__219__auto__)){
return or__219__auto__;
} else {
...
}finally {cljs.tools.reader.arg_env = arg_env6435;
}});
/**
...
var ch = temp__4423__auto__;
if(cljs.core._EQ_.call(null,"@",ch)){
return cljs.tools.reader.wrapping_reader.call(null,new cljs.core.Symbol("clojure.core","unquote-splicing","clojure.core/unquote-splicing",-552003150,null)).call(null,(function (){var G__6440 = rdr;
cljs.tools.reader.reader_types.read_char.call(null,G__6440);
...
var G__6443 = cljs.core.next.call(null,s);
var G__6444 = cljs.core.conj_BANG_.call(null,cljs.core.conj_BANG_.call(null,key_vals,cljs.core.key.call(null,e)),cljs.core.val.call(null,e));
s = G__6443;
key_vals = G__6444;
continue;
} else {
...
var or__219__auto__ = cljs.core.get.call(null,cljs.tools.reader.gensym_env,sym);
if(cljs.core.truth_(or__219__auto__)){
return or__219__auto__;
} else {
...
if((function (){var and__207__auto__ = ((!((form == null)))?((((form.cljs$lang$protocol_mask$partition0$ & (262144))) || (form.cljs$core$IWithMeta$))?true:false):false);
if(and__207__auto__){
...
))))):(cljs.core.truth_((function (){var or__219__auto__ = (form instanceof cljs.core.Keyword);
if(or__219__auto__){
return or__219__auto__;
} else {
var or__219__auto____$1 = typeof form === 'number';
if(or__219__auto____$1){
return or__219__auto____$1;
} else {
var or__219__auto____$2 = typeof form === 'string';
if(or__219__auto____$2){
return or__219__auto____$2;
} else {
var or__219__auto____$3 = (form == null);
if(or__219__auto____$3){
return or__219__auto____$3;
} else {
var or__219__auto____$4 = cljs.tools.reader.bool_QMARK_.call(null,form);
if(cljs.core.truth_(or__219__auto____$4)){
return or__219__auto____$4;
} else {
...
var gensym_env6452 = cljs.tools.reader.gensym_env;
...
}finally {cljs.tools.reader.gensym_env = gensym_env6452;
}});
...
var temp__4423__auto__ = (function (){var or__219__auto__ = cljs.tools.reader._STAR_data_readers_STAR_.call(null,tag);
if(cljs.core.truth_(or__219__auto__)){
return or__219__auto__;
} else {
...
var args6459 = [];
var len__1277__auto___6463 = arguments.length;
var i__1278__auto___6464 = (0);
while(true){
if((i__1278__auto___6464 < len__1277__auto___6463)){
args6459.push((arguments[i__1278__auto___6464]));

var G__6465 = (i__1278__auto___6464 + (1));
i__1278__auto___6464 = G__6465;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str("Invalid arity: "),cljs.core.str(args6459.length)].join('')));
...
var args6467 = [];
var len__1277__auto___6473 = arguments.length;
var i__1278__auto___6474 = (0);
while(true){
if((i__1278__auto___6474 < len__1277__auto___6473)){
args6467.push((arguments[i__1278__auto___6474]));

var G__6475 = (i__1278__auto___6474 + (1));
i__1278__auto___6474 = G__6475;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str("Invalid arity: "),cljs.core.str(args6467.length)].join('')));
...
cljs.tools.reader.read.cljs$core$IFn$_invoke$arity$2 = (function (p__6470,reader){
var map__6471 = p__6470;
var map__6471__$1 = ((((!((map__6471 == null)))?((((map__6471.cljs$lang$protocol_mask$partition0$ & (64))) || (map__6471.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__6471):map__6471);
var opts = map__6471__$1;
var eof = cljs.core.get.call(null,map__6471__$1,new cljs.core.Keyword(null,"eof","eof",-489063237),new cljs.core.Keyword(null,"eofthrow","eofthrow",-334166531));
...
var args6477 = [];
var len__1277__auto___6480 = arguments.length;
var i__1278__auto___6481 = (0);
while(true){
if((i__1278__auto___6481 < len__1277__auto___6480)){
args6477.push((arguments[i__1278__auto___6481]));

var G__6482 = (i__1278__auto___6481 + (1));
i__1278__auto___6481 = G__6482;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str("Invalid arity: "),cljs.core.str(args6477.length)].join('')));
...
if(cljs.core.truth_((function (){var and__207__auto__ = s;
if(cljs.core.truth_(and__207__auto__)){
return !((s === ""));
} else {
return and__207__auto__;
